...
// title
 ...
 y+=150;
    ...
    text(x-350,y-450,"'space' to start/stop   '+' to speedup engine   '-' to slowdown engine",0);

    text(x+871,y-580,"BY:",0);
     text(x+870,y-600,"JEEVAN BASRI BS (4VM20CS030)",0);
      text(x+871,y-620,"KARTHIK E M (4VM20CS032)",0);
